...
Delayed Recall drawings (Median = X) were [significantly more / not more] recognizable than Category Drawings (Median = X), W = X, Z = X, [p = X], rank-biserial r = X, 95% CI [X, X].
